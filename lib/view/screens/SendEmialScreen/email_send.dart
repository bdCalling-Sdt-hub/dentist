...
//                   child: Row(
//                     mainAxisAlignment: controller.messageList[index].sender == "patient"
...
//                         width: 8,
//                       ),
//                       if (controller.messageList[index].messageType == "image")
//                         Container(
//                             height: 200.h,
//                             width: 200.w,
...
//                                     )))),
//                       if (controller.messageList[index].messageType == "text")
//                         Flexible(
//                           child: Row(
//                             mainAxisAlignment: controller.messageList[index].sender == "patient"
//                                 ? MainAxisAlignment.end
...
//                                         bottomLeft: controller.messageList[index].sender == "patient"
//                                             ? Radius.circular(8.r)
//                                             : Radius.circular(0.r),
//                                         bottomRight: controller.messageList[index].sender == "patient"
//                                             ? Radius.circular(8.r)
//                                             : Radius.circular(0.r),
//                                       ),
//                                       color: controller.messageList[index].sender == "patient"
//                                           ? AppColors.loght100
//                                           : AppColors.dark900),
//                                   child: CustomText(
//                                     maxLines: 10,
